...
| OpenAI Responses API | client | not implemented | | OpenAI's documentation is blocked from the build environment; recorded in `docs/feature-matrix.md` and `openspec/DEFERRED.md`. |
